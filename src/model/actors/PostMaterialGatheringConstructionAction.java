...
/**
 * This is basically the old ConstructAction, but should not be called directly or else the 
 * process of gathering building materials will be circumvented.
 * 
 * @author Katherine Walters
 * @author Jonathan Davis
 *
 */
public class PostMaterialGatheringConstructionAction extends Action {

	private static final long serialVersionUID = 9034775605734527869L;
	private List<Position> blocksToChange;
	private Room room;
	boolean cleared, blocksAsigned, blocksPlaced, furnitureAsigned, furniturePlaced;

	public PostMaterialGatheringConstructionAction(Room room) {
		this.room = room;
